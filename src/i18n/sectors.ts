...
const SECTOR_PRICING_RAW: Record<SectorKey, LocalizedPricing> = {
  vastgoed: {
    en: {
      starter: ["Appointments auto-scheduled via WhatsApp", "Automatic confirmation + address to buyer", "Reminder 24h before every viewing", "Auto-reschedule on cancellation", "Monthly overview report"],
      pro: ["Everything in Starter, plus:", "AI writes property descriptions in 30 seconds", "Leads automatically followed up after 48h", "Full monthly report with leads and conversion", "Priority support within 4h"],
      allin: ["Everything in Pro, plus:", "Invoices auto-generated after every deal", "Costs auto-categorized by type", "Monthly summary ready for your accountant", "VAT return automatically tracked"],
      agent: ["Everything in All-in, plus:", "Emails automatically read and answered", "Full calendar management without your input", "Daily report every morning at 7am", "Leads automatically scored by intent"],
    },
    nl: {
      starter: ["Afspraken automatisch inplannen via WhatsApp", "Automatische bevestiging + adres naar koper", "Herinnering 24u voor elke bezichtiging", "Automatisch herplannen bij annulatie", "Maandelijks overzichtsrapport"],
      pro: ["Alles van Starter, plus:", "AI schrijft woningbeschrijvingen in 30 seconden", "Leads automatisch opgevolgd na 48u", "Volledig maandrapport met leads en conversie", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "Facturen automatisch aangemaakt na elke deal", "Kosten automatisch gesorteerd per categorie", "Maandoverzicht klaar voor uw boekhouder", "BTW-aangifte automatisch bijgehouden"],
      agent: ["Alles van All-in, plus:", "E-mails automatisch gelezen en beantwoord", "Volledig agendabeheer zonder uw tussenkomst", "Dagelijks rapport elke ochtend om 7u", "Leads automatisch gescoord op interesse"],
    },
    fr: {
  ...
  tandartsen: {
    en: {
      starter: ["Appointments auto-scheduled via WhatsApp", "Confirmation automatically sent to patient", "Reminder 48h before every appointment", "Auto-reschedule on cancellation", "Waiting list automatically managed"],
      pro: ["Everything in Starter, plus:", "Patient questions automatically answered", "Satisfaction survey after every treatment", "Full monthly report with no-show stats", "Priority support within 4h"],
      allin: ["Everything in Pro, plus:", "Invoices auto-generated after treatment", "Insurance certificates processed automatically", "Monthly summary ready for your accountant", "VAT return automatically tracked"],
      agent: ["Everything in All-in, plus:", "Emails automatically read and answered", "Full calendar management without your input", "Daily report every morning at 7am", "Patients automatically prioritized"],
    },
    nl: {
      starter: ["Afspraken automatisch inplannen via WhatsApp", "Bevestiging automatisch verstuurd naar patiënt", "Herinnering 48u voor elke afspraak", "Automatisch herplannen bij annulatie", "Wachtlijst automatisch beheerd"],
      pro: ["Alles van Starter, plus:", "Patiëntvragen automatisch beantwoord", "Tevredenheidsenquête na elke behandeling", "Volledig maandrapport met no-show cijfers", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "Facturen automatisch aangemaakt na behandeling", "Mutualiteitsattesten automatisch verwerkt", "Maandoverzicht klaar voor uw boekhouder", "BTW-aangifte automatisch bijgehouden"],
      agent: ["Alles van All-in, plus:", "E-mails automatisch gelezen en beantwoord", "Volledig agendabeheer zonder uw tussenkomst", "Dagelijks rapport elke ochtend om 7u", "Patiënten automatisch gescoord op prioriteit"],
    },
    fr: {
  ...
  kinesisten: {
    en: {
      starter: ["Sessions auto-scheduled via WhatsApp", "Confirmation automatically sent to patient", "Reminder 24h before every session", "Series of sessions automatically planned", "Monthly overview report"],
      pro: ["Everything in Starter, plus:", "Treatment notes via voice dictation", "Patient progress automatically tracked", "Full monthly report with treatment stats", "Priority support within 4h"],
      allin: ["Everything in Pro, plus:", "Invoices auto-generated per session", "Insurance certificates processed automatically", "Monthly summary ready for your accountant", "VAT return automatically tracked"],
      agent: ["Everything in All-in, plus:", "Emails automatically read and answered", "Full patient file automatically maintained", "Daily report every morning at 7am", "Patient follow-up fully automated"],
    },
    nl: {
      starter: ["Sessies automatisch inplannen via WhatsApp", "Bevestiging automatisch verstuurd naar patiënt", "Herinnering 24u voor elke sessie", "Reeks van sessies automatisch ingepland", "Maandelijks overzichtsrapport"],
      pro: ["Alles van Starter, plus:", "Behandelverslagen automatisch via spraak", "Voortgang patiënt automatisch bijgehouden", "Volledig maandrapport met behandelcijfers", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "Facturen automatisch aangemaakt per sessie", "Mutualiteitsattesten automatisch verwerkt", "Maandoverzicht klaar voor uw boekhouder", "BTW-aangifte automatisch bijgehouden"],
      agent: ["Alles van All-in, plus:", "E-mails automatisch gelezen en beantwoord", "Volledig dossier per patiënt bijgehouden", "Dagelijks rapport elke ochtend om 7u", "Patiëntenopvolging volledig geautomatiseerd"],
    },
    fr: {
  ...
  accountants: {
    en: {
      starter: ["Invoices automatically processed via OCR", "Bank statements automatically matched", "Client questions automatically answered", "Payment reminders automatically sent", "Monthly overview report"],
      pro: ["Everything in Starter, plus:", "Deadlines automatically monitored per client", "Client files automatically maintained", "Full monthly report per client", "Priority support within 4h"],
      allin: ["Everything in Pro, plus:", "VAT return automatically prepared", "Invoices auto-split and categorized", "Monthly summary ready for filing", "Compliance monitoring automatic"],
      agent: ["Everything in All-in, plus:", "Emails automatically read and answered", "Full client communication automated", "Daily report every morning at 7am", "Fraud detection automatically flagged"],
    },
    nl: {
      starter: ["Facturen automatisch verwerkt via OCR", "Bankafschriften automatisch gematcht", "Klantvragen automatisch beantwoord", "Betalingsherinneringen automatisch verstuurd", "Maandelijks overzichtsrapport"],
      pro: ["Alles van Starter, plus:", "Deadlines automatisch bewaakt bij klanten", "Klantdossiers automatisch bijgehouden", "Volledig maandrapport per klant", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "BTW-aangifte automatisch voorbereid", "Facturen automatisch gesplitst en gecategoriseerd", "Maandoverzicht klaar voor indiening", "Compliance monitoring automatisch"],
      agent: ["Alles van All-in, plus:", "E-mails automatisch gelezen en beantwoord", "Volledige klantcommunicatie geautomatiseerd", "Dagelijks rapport elke ochtend om 7u", "Fraudedetectie automatisch gesignaleerd"],
    },
    fr: {
  ...
  architecten: {
    ...
    nl: {
      starter: ["Afspraken automatisch inplannen via WhatsApp", "Bevestigingen automatisch verstuurd", "Projectupdates automatisch verstuurd aan klanten", "Vergaderingen automatisch ingepland", "Maandelijks overzichtsrapport"],
      pro: ["Alles van Starter, plus:", "Offertes automatisch gegenereerd via template", "Dossiers automatisch bijgehouden per project", "Volledig maandrapport per project", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "Facturen automatisch aangemaakt per fase", "Kosten automatisch gesorteerd per project", "Maandoverzicht klaar voor uw boekhouder", "Vergunningsstatus automatisch bewaakt"],
      agent: ["Alles van All-in, plus:", "E-mails automatisch gelezen en beantwoord", "Volledige projectcommunicatie geautomatiseerd", "Dagelijks rapport elke ochtend om 7u", "Klanten automatisch geïnformeerd bij elke update"],
    },
    fr: {
  ...
  garages: {
    ...
    nl: {
      starter: ["Afspraken automatisch inplannen via WhatsApp", "Klant automatisch verwittigd bij binnenkomst", "Klant automatisch verwittigd als wagen klaar is", "Onderhoud herinnering 1 jaar later automatisch", "Maandelijks overzichtsrapport"],
      pro: ["Alles van Starter, plus:", "Offertes automatisch gegenereerd via WhatsApp", "APK-keuring herinnering automatisch verstuurd", "Volledig maandrapport met omzetcijfers", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "Facturen automatisch aangemaakt na herstelling", "Kosten automatisch gesorteerd per categorie", "Maandoverzicht klaar voor uw boekhouder", "BTW-aangifte automatisch bijgehouden"],
      agent: ["Alles van All-in, plus:", "E-mails automatisch gelezen en beantwoord", "Volledige klantcommunicatie geautomatiseerd", "Dagelijks rapport elke ochtend om 7u", "Klanten automatisch geïnformeerd bij elke stap"],
    },
    fr: {
  ...
  horeca: {
    ...
    nl: {
      starter: ["Reserveringen automatisch verwerkt via WhatsApp", "Bevestiging automatisch verstuurd naar gast", "Herinnering dag voor de reservering automatisch", "No-show opvolging automatisch", "Maandelijks overzichtsrapport"],
      pro: ["Alles van Starter, plus:", "Personeelsplanning automatisch gegenereerd", "Verjaardagskortingen automatisch verstuurd", "Volledig maandrapport met bezettingscijfers", "Prioriteit support binnen 4u"],
      allin: ["Alles van Pro, plus:", "Facturen automatisch aangemaakt per tafel", "Kosten automatisch gesorteerd per categorie", "Maandoverzicht klaar voor uw boekhouder", "BTW-aangifte automatisch bijgehouden"],
      agent: ["Alles van All-in, plus:", "Reviews automatisch gemonitord en gesignaleerd", "Volledige gastcommunicatie geautomatiseerd", "Dagelijks rapport elke ochtend om 7u", "Slechte reviews direct gemeld aan zaakvoerder"],
    },
    fr: {
